...
class ExtraController extends \yii\rest\ActiveController
{
    public $modelClass = 'app\modules\v1\models\Users';
    public $usersBodyClass = 'app\modules\v1\models\UsersBodyInfo';
    public $usersInvestigationClass = 'app\modules\v1\models\UsersInvestigation';
    ...
    public function actionIndex()
    {
        ...
        $usersInvestigation = $this->usersInvestigationClass::findAllRecords();
        ...
        if (is_null($usersInvestigation)) {
            ...
            $response->data = $usersInvestigation;
        }
        return $response;
    }
    ...
    public function actionFindOne($id)
    {
        ...
        if (is_null($identity)) {
            ...
            $usersInvestigation = $this->usersInvestigationClass::findOneRecord($id);
    ...
    public function actionCreate($id)
    {
        ...
        if (is_null($user)) {
            ...
            $usersInvestigation = $this->usersInvestigationClass::createData($id, $params);
            ...
            if (is_null($usersInvestigation)) {
                ...
                if ($usersInvestigation == "NUMBER_NOT_MATCH") {
                    $response->statusCode = 409;
                    $response->data = [
                        'message' => '答案數量與題目數量不符合．',
                    ];
                } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if (is_null($user)) {
            ...
            $modPsycho = $this->usersInvestigationClass::updateData($id, $params);
    ...
    public function actionDelete($id)
    {
        ...
        if (is_null($user)) {
            ...
            if (is_null($identity)) {
                ...
                if ($role === 1) {
                    // Staff role
                    $this->usersInvestigationClass::deleteData($id);
                    $response->statusCode = 200;
                    $response->data = [
                        'message' => '刪除成功',
                    ];
